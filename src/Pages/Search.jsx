...
const Search = ({ Page, setPage, Tdata, setTData, setID, searchResults }) => {
                ...
                data ?
                    data.slice(0, 10).map((ele, index) => {
                        if (ele.Type === searchResults.toLowerCase()) {
                            return (
                                <div key={index} className="basis-1/1 w-64 border border-gray-200 rounded-lg shadow hover:shadow-lg bg-white">
